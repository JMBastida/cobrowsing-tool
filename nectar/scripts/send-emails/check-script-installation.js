...
// const templateId = 2833028;

// let entitiesCollection;
// let usersCollection;

// async function checkRoomsStats(entity) {
//   const roomCollection = getCollection(entity._id, 'rooms');
//   const filter = {
//     $or: [
//       { 'stats.widget.show': { $gt: 0 } },
//       { 'stats.widget.unavailable': { $gt: 0 } },
//     ]
//   };
//   const totalRooms = await roomCollection.countDocuments(filter);
//   return !!totalRooms;
// }
...
//   const hasRoomsStats = await checkRoomsStats(entity);
//   const query = { _id: entity._id };
//   if (hasRoomsStats) {
//     const update = { $set: { isScriptInstalled: true, modificationDate: new Date() } };
...
//   const filter = {
//     emailsSent: { $nin: [ENTITY_EMAIL_TYPE.CHECK_SCRIPT_INSTALLATION] },
